    ...
    return (
        <div className="chatbot-container">
            ...
            <div className="input-container">
                ...
                />
                <datalist id="options">
                    <option value="Let's start over."></option>
                    ...
                    <option value="Undergraduate admissions requirements - BS program"></option>
                    <option value="Typical 4-year course planning guide (on campus or distance student) - BS program"></option>
                    <option value="Typical 4-year course planning guide (online campus) - BS program"></option>
                    ...
                    <option value="Graduate admission requirements - MS program"></option>
                    <option value="Required course work - MS program"></option>
                    <option value="Required courses and their prerequisites - MS program"></option>
                    ...
                    <option value="Graduate admission requirements - PhD program"></option>
                    <option value="Required course work - PhD program"></option>
                    <option value="Potential minor options - PhD program"></option>
                    <option value="Required courses and their prerequisites - PhD program"></option>
